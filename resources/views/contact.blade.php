...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="/landingpage/vendor/simple-line-icons/css/simple-line-icons.css">
    <link href="https://fonts.googleapis.com/css?family=Lato" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Catamaran:100,200,300,400,500,600,700,800,900" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Muli" rel="stylesheet">

    <!-- Plugin CSS -->
    <link rel="stylesheet" href="/landingpage/device-mockups/device-mockups.min.css">

    <!-- Custom styles for this template -->
    <link href="/landingpage/css/new-age.min.css" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="/" style="color: white;">Rene Cayetano Elementary School Learning Management System</a>
    ...
    <section class="contact" id="contact" style="background-image: url(/landingpage/1.jpg); background-size: 1500px 750px;">
      <div class="container">
    ...
    <script src="/landingpage/js/new-age.min.js"></script>
